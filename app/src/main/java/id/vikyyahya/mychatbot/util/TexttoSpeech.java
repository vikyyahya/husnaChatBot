package id.vikyyahya.mychatbot.util;
...
public class TexttoSpeech extends UtteranceProgressListener implements TextToSpeech.OnInitListener {
    ...
    public TexttoSpeech(Context context, Locale locale, String ttsEngine) {
        this.locale = locale;
